...
- - You will get the message “_there was a problem parsing the package_” if your Android version is not sufficient.
...
**Skins:** As of this moment, all skins that worked in Helix should still work in _Isengard_. Though in PVR there are certain changes that might be noticeable and need specific skin changes. These changes are minimal and shouldn’t cause any major problems in usability. Overall you should be able to enjoy this alpha build without any problems in this area.
