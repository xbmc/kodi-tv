import { Button, List, ListItem, ListVariant } from "@patternfly/react-core"
import ArrowRightIcon from "@patternfly/react-icons/dist/js/icons/arrow-right-icon"
import MetadataHeader from "src/components/SiteMetadata"

<MetadataHeader title="Get Involved" />
...
<Button
  ...
  target="_blank"
  rel="noopener"
  href="https://forum.kodi.tv"
  isLarge
>
  Visit the Forums <ArrowRightIcon />
</Button>
...
<Button
  ...
  target="_blank"
  rel="noopener"
  href="https://kodi.wiki/index.php?title=HOW-TO:Help_with_quality_assurance_testing"
  isLarge
>
  Help with QA <ArrowRightIcon />
</Button>
...
<Button variant="link" component="a" href="/contribute/developers" isLarge>
  Help with Coding <ArrowRightIcon />
</Button>
...
<Button
  ...
  target="_blank"
  rel="noopener"
  href="https://kodi.wiki/index.php?title=Translation_System"
  isLarge
>
  Help with Translations <ArrowRightIcon />
</Button>
...
<Button
  ...
  target="_blank"
  rel="noopener"
  href="https://kodi.wiki/view/Add-on_development"
  isLarge
>
  Build Your First Add-On <ArrowRightIcon />
</Button>
...
<Button variant="link" component="a" href="/donate" isLarge>
  Donate to Kodi <ArrowRightIcon />
</Button>
...
<Button variant="link" component="a" href="/store" isLarge>
  Purchase Kodi Merch <ArrowRightIcon />
</Button>
