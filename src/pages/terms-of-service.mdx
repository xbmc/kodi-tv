...
<MetadataHeader title="Terms of Service" />
...
The purpose of entering the email address on the registration form is solely to allow the Foundation to identify the Users and to communicate with them. The Foundation is entitled to send Users messages pertaining to technical matters, the operation and the functions of the facilities provided. To this end, Users must ensure that their email address is always kept up-to-date. 

The entered email address will not be used for tracking or marketing purposes, nor will it be shared with or sold to any third party agency.
