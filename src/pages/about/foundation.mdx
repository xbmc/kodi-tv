...
The XBMC Board of Directors are Foundation members that manages the Kodi Foundation. The Board consists of five seats that are chosen by vote from the Kodi Foundation members. The Board’s responsibilities include management of funds, publicity, and all business related issues (taxes, communication with other businesses, maintaining non-profit status etc.)
