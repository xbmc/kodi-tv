...
The “XBMC Foundation” is the non-profit organization that operates the Kodi project by handling monetary as well as IP-related issues. The XBMC Foundation is a non-profit organization, registered in the US.

## Members

Membership of the XBMC Foundation is typically taken from members of Team Kodi, but may include non Team members.
...
## What is expected of an XBMC Board member?
...
## Who can be an XBMC Board member?
...
[The XBMC Foundation Articles of Incorporation](https://kodi.wiki/images/3/30/Delaware_Incorporation_Notice.pdf)

[The XBMC Foundation By-Laws](https://kodi.wiki/images/a/a0/ByLaws.pdf)
