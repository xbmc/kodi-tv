...
The only official versions of Kodi may be found in our [XBMC Foundation Downloads area](/download). Official versions of Kodi will exclusively be hosted at <http://mirrors.kodi.tv>, with the exception of certain specific Linux distributions.

# XBMC Foundation Remote Controls
...
<Gallery hasGutter>
  <GalleryItem>
      <div align="center">
        <h3>Kore™ (Android)</h3>
        <img alt="Kore QR Code" src="/images/kore-qr.png" />
      </div>
    </GalleryItem>
  <GalleryItem>
      <div align="center">
        <h3>Official Kodi Remote (iOS)</h3>
        <img alt="iOS QR Code" src="/images/ios-qr.png" />
      </div>
    </GalleryItem>
</Gallery>
