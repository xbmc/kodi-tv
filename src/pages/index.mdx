...
<div style={{ marginTop: "-150px", overflow: "hidden", marginRight: "-55px", marginLeft: "-55px" }}>
  <img width="100%" height="auto" alt="" src="/images/heroes/addons.jpg" />
</div>
...
You can [get a new skin](/addons/category/skins) to change the look of Kodi, or [install a PVR addon](/addons/category/pvr-clients) to watch and record your favourite tv shows. Maybe you want to [stream your favourite internet radio station](/addons/category/music-addons) and control it all with your web browser or mobile phone? [This and so much more is all possible](/addons) and easy with Kodi.

<Button variant="link" component="a" href="/about" isLarge>Show me all the good bits <ArrowRightIcon/></Button>
...
<Button variant="link" component="a" href="/contribute" isLarge>Other ways to help <ArrowRightIcon/></Button>
