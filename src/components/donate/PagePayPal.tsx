    ...
    this.state.buttondisabled =
      (this.state.dtype === "One-time" &&
        (parseInt(this.state.amount) <
          siteConfig.stripe.minCharge[this.state.currency_code] ||
          this.state.amount == "")) ||
      (this.state.dtype !== "One-time" &&
      ...
      <>
        <DefaultLayout frontmatter={frontmatter}>
          <form
            id="paypal"
            action={
              import.meta.env.GATSBY_PAYPAL_URL || import.meta.env.PUBLIC_PAYPAL_URL
            }
            method="post"
            acceptCharset="UTF-8"
          >
            <input
              ...
              name="business"
              value={
                import.meta.env.GATSBY_PAYPAL_BUSINESS ||
                import.meta.env.PUBLIC_PAYPAL_BUSINESS
              }
            />
